...
const Faq = () => {
    const accordionData = [
        ...
        {
            title: "4. Is there a limit to the number of participants in the webinar?",
        ...
        {
            title: "6. Will there be opportunities for networking with other attendees?",
        ...
        {
            title: "8. Are there any technical requirements to participate in the webinar?",
        ...
        {
            title: "10. Who will be taking care of that particular batch of students?",
    ...
    return (_jsxs("div", { className: "faq", children: [_jsx("div", { className: "faq-headings", children: _jsx("div", { className: "faq-head1", children: _jsx("p", { children: "Frequently Asked Questions" }) }) }), _jsx("div", { className: "faq-accordion", children: accordionData
                    .slice(0, displayCount)
                    .map(({ title, content }, index) => (_jsx(FaqAccordion, { title: title, content: content }, index))) }), _jsx("div", { className: "read-more-button-container", children: _jsx("button", { className: "read-more-button", onClick: handleReadMoreClick, children: isCollapsed ? "Read More....." : "Collapse......" }) })] }));
};
export default Faq;
