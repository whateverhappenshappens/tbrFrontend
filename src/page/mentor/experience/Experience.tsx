...
const Experience: React.FC = () => {
  ...
  const para4 =
    "Strengthen connections for strategic industry partnerships and collaborations.";
  const para5 = "Experience real-world professional environments for insight.";
  const para6 =
    "Get top-notch merchandise and gadgets for an unparalleled ownership experience.";
