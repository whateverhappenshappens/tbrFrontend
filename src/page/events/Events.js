...
const Events = ({ pastdata }) => {
    ...
    return (_jsx("div", { className: "events py-[50px] md:pl-[70px] md:pr-[60px] xl:my-20", children: _jsx("div", { className: "xl:pl-[140px] xl:pr-[100px]", children: _jsx(Slider, { ...settings, className: "px-[30px] text-[#2E436A]", children: pastdata?.map((card, index) => {
                    const videoId = extractVideoId(card.youtubeLink);
                    return (_jsx("div", { className: "border rounded-2xl p-10", children: _jsxs("div", { className: "w-full h-full flex flex-col gap-5", children: [_jsx("div", { className: "rounded-xl h-1/2 p-10", style: { backgroundColor: card.color }, children: videoId ? (_jsx("iframe", { width: "100%", height: "100%", src: `https://www.youtube.com/embed/${videoId}`, title: card.heading, frameBorder: "0", allow: "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture", allowFullScreen: true, className: "rounded-xl" })) : (_jsx("div", { className: "text-red-500 none", children: "Invalid YouTube URL" })) }), _jsxs("div", { className: "h-1/2 md:flex md:flex-col md:gap-5", children: [_jsx("p", { className: "vr-bold font-bold text-4xl md:text-5xl overflow-hidden", children: card.heading }), _jsx("div", { className: "vr-regular text-3xl md:text-4xl overflow-hidden", children: card.subHeading })] }), _jsx("div", { className: "vr-bold text-4xl font-bold overflow-hidden", children: card.speakerName })] }) }, index));
                }) }) }) }));
};
export default Events;
