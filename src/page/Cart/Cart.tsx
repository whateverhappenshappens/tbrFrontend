...
//                     : "hover:bg-white hover:text-[#6D87F5] cursor-pointer"
//                 }`}
//               >
//                 {isLoggedIn ? (
...
//     // Example:
//     // axios.post(`your_payment_endpoint`, requestData)
//     //   .then(response => {
...
//                       : `${(
//                           ((netPriceObj.totalPrice -
//                             netPriceObj.totalDiscountedPrice) /
//                             netPriceObj.totalPrice) *
//                           100
//                         ).toFixed(2)}% off`}
//                   </div>
...
//               )}
//             </div>
//             {/* <div className="cart-value text-3xl lg:text-4xl font-semibold">
...
//         </div>
//       )}
//       {isSignupPopupVisible && <Signup closePopup={toggleSignupPopup} />}
//     </div>
//   );
// };
