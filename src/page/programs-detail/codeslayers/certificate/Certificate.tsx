      ...
      <div className="certificate-content">
        <div className="certificate-text">
          <p>
            ...
            demonstrated consistently during the sessions. This badge
            acknowledges the participant's hard work shown through their
            performance on regular assignments and quizzes throughout the
            training period.
          </p>
        </div>
