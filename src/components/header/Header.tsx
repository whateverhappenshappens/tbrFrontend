...
//   // useEffect(() => {
//   //   // Example: fetch the user data or perform any check to set loggedInUserEmail
//   //   if (isLoggedIn) {
//   //     // Fetch user email or data here, if needed
//   //   }
//   // }, [isLoggedIn]);
    ...
    <header className="header" ref={headerContainer}>
      ...
      <nav className="main-nav open" ref={mainNav}>
        ...
        <ul className="nav-list capitalize">
          ...
          <li className="more-btn-display" ref={dropdownRef}>
