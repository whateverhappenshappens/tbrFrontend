    ...
    const handle_login_btn = async () => {
        if (validateForm()) {
            ...
            try {
                ...
                setIsLoading(false); // Stop the loader after login attempt
            }
        }
    };
            ...
            children: _jsxs("div", {
                ...
                children: [
                    _jsxs("aside", {
                        className: "left",
                        children: [
                            _jsx("img", { src: logo2, alt: "TechBairn Logo", className: "logo121" }),
                            _jsxs("h2", { children: ["We are glad ", _jsx("br", {}), "you are back!"] }),
                            _jsx("p", {
                                className: "para",
                                children: "Discover India's best EdTech platform for upskilling yourself with community-based learning.",
                            }),
                            _jsx(ReviewSlider, {}),
                        ],
                    }),
                    _jsxs("div", {
                        ...
                        children: [
                            ...
                            errors.email && _jsx("div", { className: "error", children: errors.email }),
                                ...
                                children: [
                                    ...
                                    _jsx("button", {
                                        ...
                                        children: showPassword
                                            ? _jsx(FaEyeSlash, { className: "icon" })
                                            : _jsx(FaEye, { className: "icon" }),
                                    }),
                                ],
                            }),
                            errors.password && _jsx("div", { className: "error", children: errors.password }),
                            _jsx("div", {
                                className: "new",
                                children: _jsx("div", { className: "pass", children: "Forget Password?" }),
                            }),
                            _jsx("br", {}),
                            _jsx("button", {
                                className: "btn1",
                                onClick: handle_login_btn,
                            ...
                            _jsx("p", { className: "cont", children: "-------or continue login with--------" }),
                            _jsx("div", {
                                className: "google",
                                children: _jsx("button", { onClick: handleLogin, children: "Google" }),
                            }),
                        ],
                    }),
                    isSignupPopupVisible &&
                        _jsx("div", {
                            className: "signup absolute w-[100%] ml-[114px] overflow-y-hidden h-full bg-white top-[0%] border",
